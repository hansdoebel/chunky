...
from docling.document_converter import DocumentConverter, PdfFormatOption, WordFormatOption, PowerpointFormatOption, HTMLFormatOption, ImageFormatOption
...
def main():
    parser = argparse.ArgumentParser(description="Chunk documents using Docling")
    parser.add_argument("--input", required=True, type=Path, help="Input file (PDF, DOCX, PPTX, HTML, images, etc.)")
